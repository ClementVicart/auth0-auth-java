...
public class Auth0AutoConfiguration {
   ...
   * @param domainResolverProvider optional {@link DomainResolver} bean for dynamic MCD resolution.
   *     When present, it takes precedence over static YAML config.
   * @param cacheProvider optional {@link AuthCache} bean for custom caching (e.g., Redis). When
   *     present, {@code cacheMaxEntries} and {@code cacheTtlSeconds} properties are ignored.
